...
require 'first_payment_schedule'

RSpec.describe FirstPaymentSchedule do
  describe 'FirstPaymentSchedule' do
    let(:dummy_class) { Class.new }
    before do
      dummy_class.extend(FirstPaymentSchedule)
    end
    ...
    it 'returns the amortization schedule for the loan' do
      ...
      amortization_schedule = dummy_class.first_payment_schedule(principal_amount: loan.loan_amount,
                                                                                                    term: loan.term,
